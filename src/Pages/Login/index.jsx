...
const Login = () => {
  const handleLogin = async () => {
    console.log(`${process.env.REACT_APP_API_URL}/google`);
    const response = await axios(`${process.env.REACT_APP_API_URL}/google`);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md space-y-4">
        ...
        <div className="px-6 sm:px-0 max-w-sm" onClick={handleLogin}>
          <button
            type="button"
